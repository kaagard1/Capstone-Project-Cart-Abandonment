...
```
 ...
 There are redacted NAs under Material_ID, this doesn't mean much for the google analytics join but it does represent the redacted customers who have not made an order.
```{r}
